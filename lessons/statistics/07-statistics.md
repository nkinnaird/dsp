...
>> Bayes' Theorem is given as P(A|B) = P(B|A)P(A)/P(B). I want to find the probabilty that Elvis was an identical twin, given that he was a twin and a boy. P(A|B) is the probability that a pair of babies (including Elvis) are identical twin boys. P(B|A) is the probability that a pair of identical twins are boys, which is equal to 1/2 since the identical twins can be either male or female. P(A) is the probability that a pair of babies are identical twins, equal to 1/300. P(B) is the probability that a pair of babies are twin boys. This can be expanded as P(B) = P(B|A)P(A) + P(B|C)P(C), where C stands for the complementary probability to A, that of being a twin and not identical, ie. being fraternal. P(C) = 1/125 as given in the problem statement, and P(B|C), the probabilty of a pair of babies being boys given that the babies are fraternal twins, is equal to 1/4, since the two babies can be MM, MF, FM, or FF. Plugging everything in, the probabilty that Elvis, given that he is a twin boy, is an identical twin is 5/11, or 45.5%.
